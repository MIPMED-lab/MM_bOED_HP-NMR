...
transformed parameters {
   ...
   for (j in 1:m){
      ...
      theta[3,j] = (kpl*2470)+2470;
      theta[4,j] = (kbn*5229)+5229;
      theta[5,j] = (kun*152)+152;
      theta[6,j] = (kbp*9.5)+9.5;
      theta[7,j] = (kup*915)+915;
      theta[8,j] = (kunE*4589)+4589;
      theta[9,j] = (kbnE*879)+879;
      theta[10,j] = (ki*11)+11;
      theta[11,j] = (kr*816)+816;
      theta[12,j] = 3e6;
      theta[13,j] = 1;
