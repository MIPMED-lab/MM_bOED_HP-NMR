...
transformed parameters {
   ...
   theta[1] = 48;
   theta[2] = 55;
   theta[3] = (kin*0.001)+0.00475;
   theta[4] = (kpl*0.005)+0.01375;
   theta[5] = (kbn*0.0025)+0.045;
   theta[6] = (kun*0.025)+0.55;
   theta[7] = (kbp*0.02)+0.95;
   theta[8] = (kup*0.02)+0.95;
   theta[9] = (kunE*0.02)+0.95;
   theta[10] = (kbnE*0.00025)+0.0085;
   theta[11] = (ki*0.03)+0.95;
   theta[12] = (kr*0.00015)+0.002;
   theta[13] = 15;
